...
(async () => {
  try {
    ...
    console.log('\n--- 6. Sync public ---');
    console.log(await ssh('rm -rf /opt/soha/public && cp -r /opt/soha/.next/public /opt/soha/public 2>/dev/null; rm -rf /opt/soha/.next/standalone/public && cp -r /opt/soha/public /opt/soha/.next/standalone/public'));
