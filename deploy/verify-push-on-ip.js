...
(async () => {
  await ssh('sw.js push count', 'curl -s http://87.248.145.44/sw.js | grep -c push', 20000);
  await ssh('public key via IP', 'curl -s http://87.248.145.44/api/notifications/public-key | head -c 100', 20000);
})();