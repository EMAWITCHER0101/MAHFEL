...
(async () => {
  try {
    console.log('=== mahfel config ===');
    console.log(await ssh('cat /etc/nginx/sites-available/mahfel'));
    console.log('=== soha config ===');
    console.log(await ssh('cat /etc/nginx/sites-available/soha'));
    console.log('DONE');
  } catch (e) {
