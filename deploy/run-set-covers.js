...
(async () => {
  try {
    await uploadFile(path.join(__dirname, 'set-covers.mjs'), '/opt/soha/server/set-covers.mjs');
    console.log(await ssh('cd /opt/soha/server && node set-covers.mjs', 60000));
    console.log(await ssh('rm -f /opt/soha/server/set-covers.mjs'));
  } catch (e) {
