...
(async () => {
  try {
    console.log('=== FIX WS SERVER ===');
    console.log('Stopping WS...');
    console.log(await ssh('systemctl stop soha-ws', 10000));
    await new Promise(r => setTimeout(r, 2000));
    await uploadFile('E:\\soha\\ws-server\\soha-ws-linux', '/opt/soha/soha-ws');
    console.log(await ssh('chmod +x /opt/soha/soha-ws'));
    console.log(await ssh('systemctl start soha-ws', 10000));
