...
(async () => {
  try {
    // Fix nginx to serve static from the MAIN .next/static (not standalone)
    ...
    // Restart frontend to clear any stale cache
    ...
    console.log(await ssh('curl -sI http://localhost:80/_next/static/chunks/44i7oahwj7mpr.css 2>&1 | head -5'));
