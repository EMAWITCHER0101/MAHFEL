...
const data = JSON.parse(fs.readFileSync('C:\\Users\\EMAD\\AppData\\Local\\Temp\\soha-tmp\\eitaa-all.json', 'utf8'));
...
fs.writeFileSync('C:\\Users\\EMAD\\AppData\\Local\\Temp\\soha-tmp\\eitaa-matches.json', JSON.stringify(out, null, 2));
