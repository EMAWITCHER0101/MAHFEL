...
const nginxConfig = `server {
    ...
    location /_next/static/ {
        alias /opt/soha/.next/standalone/.next/static/;
        expires 365d;
...
(async () => {
  try {
    ...
    console.log(await ssh('curl -sI http://localhost:80/_next/static/chunks/13tahokxrjv6d.css 2>&1 | head -5'));
    console.log(await ssh('curl -sI http://localhost:80/_next/static/chunks/3p5f1ahpgddxs.js 2>&1 | head -5'));
    console.log('DONE');
  } catch (e) {
