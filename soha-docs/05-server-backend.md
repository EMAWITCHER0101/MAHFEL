...
**الگوی عملکرد:** هر دو handler فقط خطا را لاگ می‌کنند و اجازه می‌دهند سرور به کار خود ادامه دهد. در محیط Production، بهتر است از PM2 یا类似的 process manager استفاده شود که سرور را به صورت خودکار ریستارت کند.
